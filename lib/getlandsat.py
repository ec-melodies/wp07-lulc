        ...
        for year, bird in years.iteritems():
            for season in seasonintervals:
                ...
                if checkexists!=None:
                    ...
                    subprocess.call('download_landsat_scene.py -z unzip -b '+bird+' -o catallogue -d '+startdate+' -f '+enddate+admitedcloudcover+' -s '+tile+' -u '+passwfile+' --output '+outputdir, shell=True)
                    l = open(logfile,'r')
